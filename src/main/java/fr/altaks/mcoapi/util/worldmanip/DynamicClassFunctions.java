package fr.altaks.mcoapi.util.worldmanip;
...
public class DynamicClassFunctions {
    ...
    public static boolean setClasses() {
        try {
            ...
            Main.LOGGER.log(Level.SEVERE, "Could not aquire a required class", e);
            return false;
        }
    }
    ...
    public static boolean setMethods() {
        try {
            ...
            Main.LOGGER.log(Level.SEVERE, "Could not find a required method", e);
            return false;
        }
    }
    ...
    public static boolean setFields() {
        try {
            ...
            Main.LOGGER.log(Level.SEVERE, "Could not find a field class", e);
            return false;
        }
    }
    ...
    public static void bindRegionFiles() {
        try {
            ...
            Main.LOGGER.info("Successfully bound to region file cache.");
        } catch (Throwable t) {
            Main.LOGGER.warning("Error binding to region file cache.");
            t.printStackTrace();
        }
    }
    ...
    public static synchronized boolean clearWorldReference(String worldName) {
        ...
        try {
            ...
            Main.LOGGER.warning("Exception while removing world reference for '" + worldName + "'!");
            ex.printStackTrace();
        }
