...
public class ItemManager {
    ...
    public static class PrebuiltItems {
        ...
        public static final ItemStack inventoryFillingGlassPane = new ItemBuilder(Material.STAINED_GLASS_PANE, 1, " ", (short)15).build();
    ...
    public static class ItemBuilder {
        ...
        public ItemBuilder(Material material, int amount, short damage, short data) {
            this.item = new ItemStack(material, amount, damage);
